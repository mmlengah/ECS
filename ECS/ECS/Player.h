...
std::shared_ptr<Entity> createPlayerPrefab(SDL_Renderer* renderer) {
    ...
    sprite->addAnimationState("idle", AnimationState(1, 6, 60));
    sprite->addAnimationState("idleLeft", AnimationState(7, 6, 60, SDL_FLIP_HORIZONTAL));
    sprite->addAnimationState("idleRight", AnimationState(7, 6, 60));    
    sprite->addAnimationState("attackingRight", AnimationState(6*6 + 4, 4, 66));
